                                ...
                                uint8_t do_ping )
{
  ...
  //printf("USBH_CtlSendData pipe_num=%d 11\n",pipe_num);
...
/**
  ...
  * @retval USBH Status. 
  */
extern GPIO_PinState bitstatus0;
extern GPIO_PinState bitstatus1;
extern GPIO_PinState bitstatus2;
extern GPIO_PinState bitstatus3;
                                ...
                                uint8_t pipe_num)
{
  ...
  printf("buff[0]=%x buff[1]=%x buff[2]=%x buff[3]=%x length=%d pipe_num=%d \n",buff[0],buff[1],buff[2],buff[3],length,pipe_num);
  ...
  bitstatus3 = buff[3];
  if(buff[0]==bitstatus0 && buff[1]==bitstatus1 && buff[2]==bitstatus2 )
  {
    bReceiveData_Check = 1;
  }
  return USBH_OK;
}
